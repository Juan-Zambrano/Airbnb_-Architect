...
def run(argv=None):	
	...
	with beam.Pipeline(options=pipeline_options) as p:
		...
		table_name = "juan-chujun:zillow.Rental_Price_1Bedroom" # format: project_id:dataset.table
		table_schema = init_bigquery_table()
    
		lines = p | 'ReadFile' >> beam.io.ReadFromText('gs://juan-chujun/zillow/Zip_MedianRentalPrice_1Bedroom.csv')
